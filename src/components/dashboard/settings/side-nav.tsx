...
const navItems = [
  {
    ...
    title: 'Personal',
    items: [
      { key: 'account', title: 'Account', href: paths.authorizedPath.settings.account, icon: 'user-circle' },
      { key: 'notifications', title: 'Notifications', href: paths.authorizedPath.settings.notifications, icon: 'bell' },
      { key: 'security', title: 'Security', href: paths.authorizedPath.settings.security, icon: 'lock-key' },
    ],
  },
  {
    key: 'organization',
    title: 'Organization',
    items: [
      { key: 'billing', title: 'Billing & plans', href: paths.authorizedPath.settings.billing, icon: 'credit-card' },
      { key: 'team', title: 'Team', href: paths.authorizedPath.settings.team, icon: 'users-three' },
    ],
  },
